...
public class JavascriptCompiler extends FunctionCompiler {
    ...
    @HaxeMethodBody(target = "js", value = "return N.box(untyped __js__('eval({0} + {1} + {2})', '(function() {', p0._str, '})()'));")
    ...
    static private class Impl extends AstVisitor {
        ...
        public void visit(Expr.InvokeStatic expr) {
            String internalClassName = JTranscInternalNames.getInternalClassName(expr.method.getDeclaringClass());
            String internalMethodName = JTranscInternalNames.getInternalMethodName(expr.method);
